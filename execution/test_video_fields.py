...
params = {
    'access_token': TOKEN,
    'fields': 'campaign_name,impressions,video_play_actions,video_p25_watched_actions,video_p50_watched_actions,video_p75_watched_actions,video_p100_watched_actions,video_15_sec_watched_actions,video_30_sec_watched_actions,video_avg_time_watched_actions',
    'level': 'campaign',
    'filtering': '[{"field":"campaign.name","operator":"CONTAIN","value":"LT581"}]',
    'date_preset': 'maximum'
}
